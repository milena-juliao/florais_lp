...
const About: React.FC = () => {
  return (
    <section id="about" className="bg-brownEarth p-28">
      <h2 className="text-3xl font-semibold text-center text-gray-800 mb-8">
        Sobre
      </h2>
      <div className="relative flex flex-col md:flex-row items-center justify-center">
        <div className="flex flex-col justify-center w-2/5">
          <p className="text-gray-700 text-lg mt-6 md:mt-0">
          ...
          <p className="text-gray-700 text-lg mt-5 md:mt-10">
        ...
        <Image
          ...
          width={200}
          height={200}
          className="w-1/4 max-w-md ml-40 rounded-lg shadow-xl z-10"
        />
        <img src="./borboleta.svg" alt="" className="absolute right-2/3 -top-44 w-3/5 opacity-15" />
      </div>
    </section>
  );
};
